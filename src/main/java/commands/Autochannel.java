...
public class Autochannel implements ICommand, Serializable {
    @Override
    ...
    */
    ...
    /*
        ...
        aus der ICommand ausgeführt wurde und sendet sie als Embed Message.
    */
    ...
    */
    ...
    public String help() {
        return "**Autochannel:**\n" +
                ":white_small_square:  `/autochannel set <Chan ID>`  -  Erkläre einen Sprachkanal zu einem Autochannel\n" +
                ":white_small_square:  `/autochannel unset <Chan ID>`  - Lösche einem Autochannel\n" +
                ":white_small_square:  `/autochannel list`  -  Zeige alle Autochannels\n";
    }
}